...
vars <- grep("^pca[1-8]$|^sdo[1-8]$|^aut[1-4]$|^adem[2-3]$|^wave$|^ID$", names(raw), value = T)
...
## Data ####
write.csv(dt,file=here::here("0_data","data_sel_v2.csv"),row.names = F)
